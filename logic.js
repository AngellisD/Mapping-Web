...
var mapboxKey= "pk.eyJ1IjoiYW5nZWxsaXMiLCJhIjoiY2p3bGZseWptMTNneTN5cDl0NWY0dno5cSJ9.VWnRWInDd-icwQTHJ7_T0w"
var mapboxURL = "https://api.mapbox.com/styles/v1/mapbox/outdoors-v11/tiles/256/{z}/{x}/{y}?"
    ...
    var earthquakes = L.geoJSON(earthquakeData, {
      pointToLayer: function (feature, latlng) {
        return L.circleMarker(latlng, {
          radius: Math.pow(1.5, feature.properties.mag),
          fillCollor: chooseColor(feature.properties.mag),
          color: "#000000",
          weight: 1,
          opacity: .5,
          fillOpacity: 0.6
